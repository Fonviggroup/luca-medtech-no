...
const partners = [
  ...
  { name: "HelseID", description: "Innlogging" },
  { name: "Noklus Diabetes", description: "Diabetesjournal" },
        ...
        <ScrollReveal>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10">
            {partners.map((partner) => (
              ...
              >
                <span className="text-lg font-bold text-primary transition-colors group-hover:text-secondary">
                  {partner.name}
                </span>
